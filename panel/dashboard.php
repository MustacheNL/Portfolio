        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="jumbotron" style="text-align: center;">
                    <h1>Hallo, welkom!</h1>
                    <img src="../images/panel/welcome.jpeg" alt="Meme Doggo" style="width: 25%;">
                    <p>
                        Je kan vanaf hier alles op je eigen Portfolio beheren. Hier boven vind je snel de handige
                        dingen.
                        Alle opties staan in het menu.
                    </p>
                </div>
            </div>
            <!-- /.col-lg-12 -->
