                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="dashboard.php"><i class="fa fa-table fa-fw"></i> Nog iets</a>
                            </li>
                            <li>
                                <a href="dashboard.php"><i class="fa fa-edit fa-fw"></i> Nog iets</a>
                            </li>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">Bewerken</span>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">Instellingen</div>
                                        <div></div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">Beheren</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="jumbotron" style="text-align: center;">
                            <h1>Hallo, welkom!</h1>
                            <img src="../images/panel/welcome.jpeg" style="width: 25%;">
                            <p>Je kan vanaf hier alles op je eigen Portfolio beheren. Hier boven vind je snel de handige dingen.  Alle opties staan in het menu.</p>
                            </p>
                        </div>
                    </div>
                    <!-- /.col-lg-12 -->
